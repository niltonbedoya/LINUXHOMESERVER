...
export HOMEPAGE_VAR_DEV_GLANCES_USERNAME="${HOMEPAGE_VAR_DEV_GLANCES_USERNAME:-homepage}"
export HOMEPAGE_VAR_DEV_GLANCES_PASSWORD="${HOMEPAGE_VAR_DEV_GLANCES_PASSWORD:-mock_ci_secret_012345678901234567890123456789}"
export HOMEPAGE_VAR_PROD_GLANCES_USERNAME="${HOMEPAGE_VAR_PROD_GLANCES_USERNAME:-homepage}"
export HOMEPAGE_VAR_PROD_GLANCES_PASSWORD="${HOMEPAGE_VAR_PROD_GLANCES_PASSWORD:-mock_ci_secret_012345678901234567890123456789}"
