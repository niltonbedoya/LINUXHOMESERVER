...
for homepage_test in runtime.sh docker-proxy.sh metrics.sh production.sh development.sh phase4.sh nilton-pc.sh dev-metrics.sh prod-metrics.sh tailscale.sh regression.sh; do
